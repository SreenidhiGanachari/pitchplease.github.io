...
public class login_entrepreneur extends AppCompatActivity {
    Button b1,b2;
    EditText ed1,ed2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_entrepreneur);
        actionbar=getSupportActionBar();
        actionbar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#1EB79B")));

        Window window = login_entrepreneur.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        ((Window) window).setStatusBarColor(ContextCompat.getColor(login_entrepreneur.this, R.color.teal_700));
    ...
    public void openActivity3() {
        Intent intent = new Intent(this, activity_tabs_entrepreneur.class);
