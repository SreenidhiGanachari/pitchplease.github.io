...
public class LandingPage1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window = LandingPage1.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        ((Window) window).setStatusBarColor(ContextCompat.getColor(LandingPage1.this, R.color.teal_700));
    ...
    public void openActivity2() {
        Intent intent = new Intent(this, login_entrepreneur.class);
        startActivity(intent);
    }
}